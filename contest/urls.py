...
from .views import ContestList, ContestProblemDetail, ContestBoundUser, DashboardView, ContestAlwaysRunningList, ClarificationView
...
urlpatterns = [
    ...
    url(r'^(?P<cid>\d+)/clarification/$', ClarificationView.as_view(), name='clarification'),
