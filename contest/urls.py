...
from .clarification import ContestClarificationView, ContestClarificationAnswer, ContestClarificationList, \
  ContestNotificationCheck
...
from .submission import ContestMyPastSubmissions, ContestSubmit, ContestBalloon, \
...
from .views import ContestList, ContestProblemDetail, ContestBoundUser, DashboardView, ContestGymList, \
  ContestPublicToggleRegister, ContestRatings, ContestStatements, ContestReward
...
urlpatterns = [
  ...
  url(r'^(?P<cid>\d+)/clarification/(?P<pk>\d+)/answer/$', ContestClarificationAnswer.as_view(),
