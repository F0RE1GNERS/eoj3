    ...
    if not show_all:
      ...
      if filter_user:
        q &= models.Q(contest=None) | \
             models.Q(contest__participants__username__contains=filter_user.username) | \
             models.Q(contest__managers__username__contains=filter_user.username) | \
             models.Q(contest__volunteers__username__contains=filter_user.username) | \
