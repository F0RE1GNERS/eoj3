...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('migrate', '0003_auto_20170729_1034'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='lang',
            field=models.CharField(choices=[('c', 'C'), ('cpp', 'C++11'), ('python', 'Python 3'), ('java', 'Java 8'), ('cc14', 'C++14'), ('cs', 'C#'), ('py2', 'Python 2'), ('php', 'PHP 7'), ('perl', 'Perl'), ('hs', 'Haskell'), ('js', 'Javascript'), ('ocaml', 'OCaml'), ('pypy', 'PyPy'), ('pas', 'Pascal'), ('rs', 'Rust')], default='cpp', max_length=12),
        ),
        migrations.AlterField(
            model_name='oldsubmission',
            name='status',
